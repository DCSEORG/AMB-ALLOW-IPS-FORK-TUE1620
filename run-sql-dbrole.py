#!/usr/bin/env python3
"""
Execute SQL script to grant database roles to the managed identity
"""
import pyodbc
import struct
...
# Database connection settings - Update these after deployment
SERVER = os.environ.get("SQL_SERVER_FQDN", "sql-expensemgmt-REPLACE.database.windows.net")
...
def execute_sql_script(server, database, script_file):
    ...
    try:
        ...
        print("\n✓ Database roles assigned successfully!")
