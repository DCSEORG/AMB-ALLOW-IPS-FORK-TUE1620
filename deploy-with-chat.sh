#!/bin/bash
# deploy-with-chat.sh - Deploy Expense Management System with GenAI resources
# Run: chmod +x deploy-with-chat.sh && ./deploy-with-chat.sh

set -e

echo "=========================================="
echo "Expense Management System - Full Deployment"
echo "Including Azure OpenAI and AI Search"
echo "=========================================="
...
echo ""
echo "Step 2: Deploying infrastructure (App Service, SQL, Managed Identity, Azure OpenAI, AI Search)..."
...
echo ""
echo "Step 9: Configuring App Service with GenAI settings..."
...
echo "✓ App Service configured with GenAI"
...
echo "  ✓ REST APIs with Swagger (/swagger)"
echo "  ✓ AI Chat Assistant (Azure OpenAI)"
echo ""
echo "Navigate to /Index to access the Expense Management System"
echo ""
